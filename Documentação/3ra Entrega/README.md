...
Alejandro Agrela 20231626, Bionda Mateus 20231666, César Pinto 20231615
...
Passos:
    ...
    Ligar o sistema e aguardar inicialização.
    Garantir ausência de movimento por 10 segundos.
    Caminhar na zona de deteção.
    Observar LED, OLED e logs.
...
Passos:
    ...
    Ligar o sistema.
    Verificar valores no OLED ou consola.
    Aumentar temperatura aproximando a mão.
    Observar atualização dos valores.
...
Passos:
    ...
    Ligar sistema.
    Confirmar que OLED mostra temperatura, humidade e estado.
    Criar movimento e verificar atualização do estado.
...
Passos:
    ...
    Simular intrusão com movimento no PIR.
    Observar ativação do buzzer.
...
Passos:
    ...
    Ligar o ESP32 com Wi-Fi ativo.
    Observar consola/logs da API.
    Confirmar receção de JSONs com leituras.
...
Passos:
    ...
    Forçar 5 leituras do ESP32.
    Abrir BD.
    Verificar se as entradas foram criadas.
...
Passos:
    ...
    Ativar alarme através de deteção de movimento (PIR).
    Aproximar um cartão RFID autorizado do leitor RC522.
    Confirmar mudança do estado da sala.
